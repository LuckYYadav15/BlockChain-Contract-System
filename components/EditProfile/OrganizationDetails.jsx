    ...
    <div className="py-4 px-10 flex flex-col font-open">
      ...
      <form onSubmit={handleSaveSubmit} className="flex flex-col mt-12 space-y-6">
        ...
        <Input
          ...
          note="Companies Name represents your Company on portal"
        />
        <TwoFields>
        <Input
          paddingY={"max"}
          ...
          name="email"
          value={form.email}
          note="Add official email of your institute for other Companies to contact you."
        />
        <Input
          paddingY={"max"}
          label="Phone"
          ...
          value={form.phone}
          note="Add official phone of your institute for other Companies to contact you."
        />
        </TwoFields>
        <Input
          paddingY={"max"}
          ...
          note="Add your company official website"
        />
        <div className="mt-6">
