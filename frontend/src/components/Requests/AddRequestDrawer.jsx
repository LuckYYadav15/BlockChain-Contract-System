        ...
        <Drawer open={isOpen} onClose={handleClose} anchor={"right"}>
            <div className="w-[50vw] p-4">
                <div className="flex justify-between font-open items-center">
                    <div className="text-lg font-semibold">{isEdit ? 'Edit Requirement' : 'Add Contract'}</div>
                ...
                <div className="text-sm text-gray-400 font-open">
                    {isEdit ? `Edit request with id ${data._id}` : 'Add Contract open to bid for all!'}
                </div>
                ...
                <form onSubmit={handleSave}>
                    <div className="mt-5 font-open">
                        ...
                        >
                            ...
                            <option value="research">Infrastructure</option>
                            <option value="physical">Medical</option>
                            <option value="productDesign">Defence</option>
                            <option value="virtual">Labour Contract</option>
                        </select>
                    </div>
                    ...
                    <div className="mt-6 space-y-6">
                        <Input
                            ...
                            value={form?.name}
                            name="name"
                            note="Give your bid a short and clear name."
                        />
                        <Input
                            ...
                            note="Give your bid a short and clear description."
                        />
                        <Input required={true} value={form.budget} name="budget" onChange={handleChange} label="Budget" type="string" note="Give your budget for the bid" />
