...
const RequestDetails = ({ selected }) => {
  ...
  return (
    <div className="bg-white shadow-md px-6 py-5">
      ...
      <div className="mt-7">
        <div className="font-semibold">Contract Overview</div>
        ...
        <div className="mt-7">
          ...
          <div className="mt-3 text-sm flex items-start gap-20">
            ...
            <div>
              <div className="font-semibold">25 Successful Projects done</div>
              <div className="flex items-center mt-1">
                <span className="text-blue-600">
                  <BiBadgeCheck />
                </span>
                <div className="text-gray-600 text-sm">
                  Verified Contractor (4.5)
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-10">
          <div className="font-semibold">Contractor Details</div>
        ...
        <div className="mt-8 flex items-center font-[500] gap-8">
          <button className="px-12 text-white py-2 bg-primary border-[1px] rounded-md">Submit</button>
